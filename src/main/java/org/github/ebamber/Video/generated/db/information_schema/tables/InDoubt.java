...
import org.github.ebamber.Video.generated.db.information_schema.tables.records.InDoubtRecord;
...
public class InDoubt extends TableImpl<InDoubtRecord> {
     ...
     */
    public final TableField<InDoubtRecord, String> TRANSACTION = createField(DSL.name("TRANSACTION"), SQLDataType.VARCHAR(2147483647), this, "");

    /**
     * The column <code>INFORMATION_SCHEMA.IN_DOUBT.STATE</code>.
     */
    public final TableField<InDoubtRecord, String> STATE = createField(DSL.name("STATE"), SQLDataType.VARCHAR(2147483647), this, "");
